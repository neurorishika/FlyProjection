...
def configure_device_events(nodemap, cam):
    ...
    try:
        ...
        if not PySpin.IsReadable(node_event_selector) or not PySpin.IsWritable(node_event_selector):
        ...
        for entry in entries:
            ...
            if not PySpin.IsReadable(node_event_notification) or not PySpin.IsWritable(node_event_notification):
            ...
            if not PySpin.IsReadable(node_event_notification_on):
