...
# upon retrieving both nodes from nodemaps and information from nodes.
#  
...
def query_interface(interface):
    ...
    try:
        ...
        if PySpin.IsReadable(node_interface_display_name):
        ...
        for i, cam in enumerate(cam_list):
            ...
            if PySpin.IsReadable(node_device_vendor_name):
            ...
            if PySpin.IsReadable(node_device_model_name):
