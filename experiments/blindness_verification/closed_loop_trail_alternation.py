#### DO NO CHANGE SECTION STARTS HERE ####
import numpy as np
import time
...
#### DO NO CHANGE SECTION STARTS ENDS HERE ####


#### CUSTOM IMPORTS SECTION STARTS HERE ####
# (Add any additional imports needed for your experiment here)


#### CUSTOM IMPORTS SECTION ENDS HERE ####
...
### CUSTOM FUNCTIONS SECTION ENDS HERE ###
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=int,
        default=60,
        help="Duration of pre-trial period in seconds",
    )
    parser.add_argument(
        "--duration_stim_per_segment",
        type=int,
        default=60,
        help="Duration of each segment of stimulus in seconds",
    )
    parser.add_argument(
        "--n_repeats",
        type=int,
