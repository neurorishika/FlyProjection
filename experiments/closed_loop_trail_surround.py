...
def get_color_at_position(
    ...
    # Check if position is on the central circular trail
    ...
    # If on the central trail, return trail color
...
# surround circle parameters
actual_surround_radius = 10  # mm; radius of the circle around the fly
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--surround_radius",
        type=float,
        default=actual_surround_radius,
        help="Radius of the surround circle in mm",
    )
    ...
    surround_radius = (
        args.surround_radius * rig_config["physical_to_camera_scaling"]
    )  # mm to pixels
                ...
                while not stop_event.is_set():
                    ...
                    if estimates is not None:
                        ...
                        for estimate in estimates:
                            ...
                            # check task status based on virtual trail position
                            if (
