...
def setup():
    ...
    ADJUSTED_CENTER_1 = relative_to_absolute(TRAIL_1_CENTER[0], TRAIL_1_CENTER[1], EXP_REGION_X, EXP_REGION_Y, WIDTH, HEIGHT)
    ...
    ADJUSTED_CENTER_2 = relative_to_absolute(TRAIL_2_CENTER[0], TRAIL_2_CENTER[1], EXP_REGION_X, EXP_REGION_Y, WIDTH, HEIGHT)
    ...
    ADJUSTED_CENTER_3 = relative_to_absolute(TRAIL_3_CENTER[0], TRAIL_3_CENTER[1], EXP_REGION_X, EXP_REGION_Y, WIDTH, HEIGHT)
