            ...
            try:
                while not stop_event.is_set():
                    ...
                    if started:
                        ...
                        cycle_duration = expansion_duration + hold_time_at_max
                        cycle_time = elapsed_time % cycle_duration

                        if cycle_time <= expansion_duration:
                            growth_fraction = cycle_time / expansion_duration
                            radius = start_radius + growth_fraction * (
